...
This generates `~/.axon-server/config.yaml` with a random JWT secret, the admin user, and creates the SQLite database. See [Quick Start](quickstart.md) for the full flow.
